...
async def _seed_data():
    ...
    seed_products = [
        {"id": make_id(), "name": "Arjuna Capsules", "slug": "arjuna-capsules", "category": "heart-health", "price": 899, "mrp": 2999, "discount": 70, "rating": 0, "reviews": 0, "inStock": True, "isBestseller": True, "isNew": False, "badge": "BESTSELLER", "shortDesc": "Arjuna bark extract for traditional Ayurvedic wellness and everyday vitality.", "description": "Aarogya Seva Arjuna Capsules use Terminalia arjuna bark extract, an herb with a long history of use in Ayurveda. Review the label, ingredient details and recommended directions before use.", "benefits": ["Traditional Ayurvedic herbal ingredient", "Supports a balanced wellness routine", "Made with Arjuna bark extract", "Vegetarian capsule", "Clear ingredient and dosage information"], "ingredients": "Arjuna Bark Extract 1000mg", "dosage": "1 capsule twice daily after meals.", "images": [IMG_ARJUNA], "stock": 500, "createdAt": now_iso()},
        {"id": make_id(), "name": "Shilajeet Capsules 1000mg", "slug": "shilajeet-capsules", "category": "mens-wellness", "price": 1399, "mrp": 4998, "discount": 72, "rating": 0, "reviews": 0, "inStock": True, "isBestseller": True, "isNew": False, "badge": "TOP SELLER", "shortDesc": "Purified Shilajeet extract for traditional Ayurvedic vitality and everyday wellness.", "description": "Aarogya Seva Shilajeet Capsules contain purified Shilajeet extract. Shilajeet has a long history of traditional Ayurvedic use; modern supplement claims can vary by preparation, so compare the ingredient amount, processing and label information.", "benefits": ["Traditional Ayurvedic ingredient", "Supports everyday vitality", "Purified extract", "Vegetarian capsule", "Clear serving information"], "ingredients": "Purified Shilajeet Extract 1000mg", "dosage": "1 capsule daily with warm milk.", "images": [IMG_SHIL_ASHWA], "stock": 500, "createdAt": now_iso()},
        {"id": make_id(), "name": "Ashwagandha Extract Capsules", "slug": "ashwagandha-extract-capsules", "category": "stress-relief", "price": 799, "mrp": 2799, "discount": 71, "rating": 0, "reviews": 0, "inStock": True, "isBestseller": True, "isNew": False, "badge": "BESTSELLER", "shortDesc": "Ashwagandha root extract for traditional Ayurvedic wellness and a balanced daily routine.", "description": "Aarogya Seva Ashwagandha Extract Capsules contain Withania somnifera root extract. Ashwagandha has a long history of use in Ayurveda; evidence and outcomes can vary by preparation and person.", "benefits": ["Traditional Ayurvedic herb", "Supports everyday wellness", "Root extract", "Vegetarian capsule", "Clear serving information"], "ingredients": "Ashwagandha Root Extract 1000mg", "dosage": "1-2 capsules daily after meals.", "images": [IMG_SHIL_ASHWA], "stock": 500, "createdAt": now_iso()},
        {"id": make_id(), "name": "Giloy Extract Capsules", "slug": "giloy-extract-capsules", "category": "immunity", "price": 649, "mrp": 2299, "discount": 71, "rating": 0, "reviews": 0, "inStock": True, "isBestseller": True, "isNew": False, "badge": "IMMUNITY", "shortDesc": "Giloy (Guduchi) extract for traditional Ayurvedic wellness and everyday vitality.", "description": "Aarogya Seva Giloy Extract Capsules contain Giloy (Guduchi) stem extract, an herb traditionally used in Ayurveda. Product use should follow the label and should not be treated as a substitute for medical care.", "benefits": ["Traditional Ayurvedic herb", "Supports everyday wellness", "Stem extract", "Vegetarian capsule", "Clear ingredient information"], "ingredients": "Giloy Stem Extract 1000mg", "dosage": "1 capsule twice daily.", "images": [IMG_PILES_GILOY], "stock": 500, "createdAt": now_iso()},
        {"id": make_id(), "name": "DIG-UP Capsules", "slug": "dig-up-capsules", "category": "mens-wellness", "price": 849, "mrp": 2998, "discount": 72, "rating": 0, "reviews": 0, "inStock": True, "isBestseller": False, "isNew": True, "badge": "NEW", "shortDesc": "Ayurvedic herbal blend formulated for men\u2019s general wellness and vitality.", "description": "DIG-UP is an Ayurvedic herbal blend for men\u2019s general wellness. Review the ingredient list, serving size and label directions before use.", "benefits": ["Men\u2019s general wellness support", "Ayurvedic herbal blend", "Supports a balanced daily routine", "Vegetarian capsule", "Clear ingredient information"], "ingredients": "Ashwagandha, Safed Musli, Shilajeet, Kaunch Beej, Gokshura", "dosage": "1 capsule twice daily.", "images": [IMG_PILES_DIGUP], "stock": 500, "createdAt": now_iso()},
        {"id": make_id(), "name": "Piles Norm Capsules", "slug": "piles-norm-capsules", "category": "specialty", "price": 749, "mrp": 2599, "discount": 71, "rating": 0, "reviews": 0, "inStock": True, "isBestseller": False, "isNew": True, "badge": "NEW", "shortDesc": "Ayurvedic herbal formulation for digestive and personal wellness.", "description": "Piles Norm is an Ayurvedic herbal formulation. Product information and directions should be read carefully, and persistent or concerning symptoms should be discussed with a qualified healthcare professional.", "benefits": ["Ayurvedic herbal formulation", "Supports digestive and personal wellness", "Plant-based ingredients", "Clear ingredient information", "Use according to label directions"], "ingredients": "Nagkesar, Haritaki, Neem, Triphala, Rasont, Kutki", "dosage": "1 capsule twice daily after meals.", "images": [IMG_PILES_GILOY, IMG_PILES_DIGUP], "stock": 500, "createdAt": now_iso()},
        {"id": make_id(), "name": "Shilajeet + Ashwagandha Combo", "slug": "shilajeet-ashwagandha-combo", "category": "mens-wellness", "price": 1899, "mrp": 6999, "discount": 73, "rating": 0, "reviews": 0, "inStock": True, "isBestseller": True, "isNew": False, "badge": "COMBO DEAL", "shortDesc": "Shilajeet + Ashwagandha combo for traditional Ayurvedic wellness and everyday vitality.", "description": "This combo pairs purified Shilajeet extract with Ashwagandha root extract. Both ingredients have a history of traditional Ayurvedic use; product claims can vary by preparation, so review the label and serving directions.", "benefits": ["Two traditional Ayurvedic ingredients", "Supports everyday wellness", "Shilajeet + Ashwagandha combination", "Convenient combo pack", "Clear serving information"], "ingredients": "Shilajeet 1000mg + Ashwagandha 1000mg (60 caps each)", "dosage": "1 of each daily.", "images": [IMG_SHIL_ASHWA], "stock": 300, "createdAt": now_iso()},
        {"id": make_id(), "name": "Piles Norm + DIG-UP Combo", "slug": "piles-digup-combo", "category": "specialty", "price": 1499, "mrp": 5499, "discount": 73, "rating": 0, "reviews": 0, "inStock": True, "isBestseller": False, "isNew": True, "badge": "COMBO", "shortDesc": "Piles Norm + DIG-UP combo for general digestive and men\u2019s wellness.", "description": "This combo pairs two Ayurvedic herbal formulations for general wellness. Review each product's ingredients and label directions before use.", "benefits": ["Two Ayurvedic herbal formulations", "General wellness support", "Convenient combo pack", "Clear ingredient information", "Use according to label directions"], "ingredients": "Piles Norm 1000mg + DIG-UP 1000mg (60 caps each)", "dosage": "1 of each twice daily.", "images": [IMG_PILES_DIGUP], "stock": 300, "createdAt": now_iso()},
    ]
